...
val1 = client.get_node("ns=2;i=524")
val2 = client.get_node("ns=2;i=525")
val3 = client.get_node("ns=2;i=526")
val4 = client.get_node("ns=2;i=527")
val5 = client.get_node("ns=2;i=528")
val6 = client.get_node("ns=2;i=529")
