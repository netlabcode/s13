...
val1 = client.get_node("ns=2;i=518")
val2 = client.get_node("ns=2;i=519")
val3 = client.get_node("ns=2;i=520")
val4 = client.get_node("ns=2;i=521")
val5 = client.get_node("ns=2;i=522")
val6 = client.get_node("ns=2;i=523")
