...
val1 = client.get_node("ns=2;i=433")
val2 = client.get_node("ns=2;i=434")
val3 = client.get_node("ns=2;i=435")
val4 = client.get_node("ns=2;i=436")
val5 = client.get_node("ns=2;i=437")
val6 = client.get_node("ns=2;i=438")
