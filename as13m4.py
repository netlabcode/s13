...
val1 = client.get_node("ns=2;i=496")
val2 = client.get_node("ns=2;i=497")
val3 = client.get_node("ns=2;i=498")
val4 = client.get_node("ns=2;i=499")
val5 = client.get_node("ns=2;i=500")
val6 = client.get_node("ns=2;i=501")
val7 = client.get_node("ns=2;i=502")
