...
val1 = client.get_node("ns=2;i=439")
val2 = client.get_node("ns=2;i=440")
val3 = client.get_node("ns=2;i=441")
val4 = client.get_node("ns=2;i=442")
val5 = client.get_node("ns=2;i=443")
val6 = client.get_node("ns=2;i=444")
